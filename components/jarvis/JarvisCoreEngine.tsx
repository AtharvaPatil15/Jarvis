...
export function DebugControls() {
  ...
  return (
    <div className="absolute bottom-8 right-8 z-30 pointer-events-auto">
      <div className="backdrop-blur-md bg-black/40 border border-amber-400/30 rounded-lg p-4 space-y-3">
        <div className="text-xs text-amber-300/70 font-mono mb-2">DEV CONTROLS</div>
        ...
        <div className="flex flex-wrap gap-2">
          {debugStates.map(({ label, state }) => (
            <button
              ...
              className="px-3 py-1.5 text-xs font-mono bg-amber-900/30 hover:bg-amber-700/50 
                        text-amber-400 border border-amber-400/30 rounded transition-all
        ...
        <div className="pt-2 border-t border-amber-400/20">
          <label htmlFor="intensity-slider" className="text-xs text-amber-300/70 font-mono block mb-2">
            INTENSITY
          </label>
          <input
            id="intensity-slider"
